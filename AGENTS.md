...
A collection of task-based skills enabling AI coding agents to integrate Chirpie — a social media API for posting to X/Twitter and Bluesky (with X Premium support for long-form posts).
...
| "Post a tweet" / "Post to Bluesky" / "Create a thread" | chirpie-posting |
