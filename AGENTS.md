...
A collection of task-based skills enabling AI coding agents to integrate Chirpie — a social media API for posting to X/Twitter, Bluesky, LinkedIn, Threads, and Mastodon (with X Premium support for long-form posts).
...
| "Post a tweet" / "Post to Bluesky" / "Post to LinkedIn" / "Post to Threads" / "Post to Mastodon" / "Create a thread" | chirpie-posting |
